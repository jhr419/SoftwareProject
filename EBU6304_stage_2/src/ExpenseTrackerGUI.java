...
public class ExpenseTrackerGUI {
    ...
    private void initialize() {
        ...
        // 设置背景颜色
        frame.getContentPane().setBackground(new Color(245, 245, 245));  // 淡灰色背景
    ...
    private void showCategoryExpenses() {
        StringBuilder categoryExpenses = new StringBuilder("分类支出统计:\n");
        ...
        for (Map.Entry<String, Double> entry : categoryTotals.entrySet()) {
            categoryExpenses.append("分类: ").append(entry.getKey()).append(" | 总支出: ").append(entry.getValue()).append("\n");
        }

        // 使用JOptionPane弹出对话框显示分类支出
        JOptionPane.showMessageDialog(frame, categoryExpenses.toString(), "分类支出", JOptionPane.INFORMATION_MESSAGE);
    }
    private void showAllTransactions() {
        StringBuilder transactions = new StringBuilder("所有交易记录:\n");
        ...
        // 弹出窗口显示滚动的交易记录
        JOptionPane.showMessageDialog(frame, scrollPane, "所有交易记录", JOptionPane.INFORMATION_MESSAGE);
    }
